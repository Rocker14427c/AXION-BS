...
grep -q 'long press here for recents' "$REPO/app/res/values/strings.xml"
check "and the hint under the slots says how, rather than describing a gesture the system eats" $?
