...
public class KnobsActivity extends Activity {
    ...
    private void runProbe() {
        if (Root.isActive()) {
            new AlertDialog.Builder(this)
                    ...
                    .setMessage(R.string.probe_needs_off)
                    .setNegativeButton(android.R.string.cancel, null)
                    .setPositiveButton(R.string.probe_turn_off, (d, w) -> {
    ...
    /** The last few lines, which is where the totals and the reason live. */
    private String summarise(String out) {
        ...
        if (b.length() == 0) b.append(getString(R.string.knobs_unavailable));
        return b.toString();
    }
